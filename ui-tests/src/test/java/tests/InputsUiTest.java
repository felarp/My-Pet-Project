...
public class InputsUiTest extends BaseTest{
    ...
    public Stream<DynamicTest> inputsTestRepeated() {
        ...
        List<Integer> randomNumbers = random.ints(10, 1,1001).boxed().toList();
        ...
        Stream<DynamicTest> negativeTests = Stream.of(
                ...
                DynamicTest.dynamicTest("Попытка пробелы до и после числа", () -> inputsPage.testInvalidInput(" 12345 ",12345)));
